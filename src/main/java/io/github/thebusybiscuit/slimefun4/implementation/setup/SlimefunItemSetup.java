...
public final class SlimefunItemSetup {
    ...
    public static void setup(@Nonnull Slimefun plugin) {
        ...
        new SlimefunItem(itemGroups.resources, SlimefunItems.COPPER_INGOT, RecipeType.SMELTERY, new ItemStack[] {
                    new ItemStack(Material.COPPER_INGOT), SlimefunItems.COPPER_DUST, null, null, null, null, null, null, null})
        .register(plugin);
        ...
        new GEOMiner(itemGroups.gps, SlimefunItems.GEO_MINER, ChestMenuUtils.getBlankTexture(), RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                    new ItemStack(Material.DIAMOND_PICKAXE),
                    SlimefunItems.MEDIUM_CAPACITOR,
                    new ItemStack(Material.DIAMOND_PICKAXE),
                    SlimefunItems.REINFORCED_ALLOY_INGOT,
