...
public final class SlimefunItems {
    ...
    public static final SlimefunItemStack NIGHT_VISION_GOGGLES = new SlimefunItemStack(
            "NIGHT_VISION_GOGGLES", Material.IRON_HELMET, Color.BLACK, "&a夜视眼镜", "", "&9+ 夜视效果");
    ...
    public static final SlimefunItemStack ENHANCED_AUTO_CRAFTER = new SlimefunItemStack(
            ...
            "&2自动合成机 &8(高级)",
            "",
            "&f将机器放在任意能装物品的方块上", "&f就能自动合成任何东西!", "&f可以合成 &e高级工作台 &f能合成的物品", "", LoreBuilder.machine(MachineTier.ADVANCED, MachineType.MACHINE), "&8⇨ &e⚡ &7合成物品消耗 16 J");
